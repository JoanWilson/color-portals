...
class FinalPortalViewController: UIViewController {
...
// MARK: - UI Methods
extension FinalPortalViewController {
    ...
    private func setupPortal() -> SCNNode {
        ...
        let leftWall = boxManager.createFinalWall(isDoor: false)
        ...
        let rightWall = boxManager.createFinalWall(isDoor: false)
        rightWall.position = SCNVector3.init((boxManager.length/2) - boxManager.width,0,0)

        let topWall = boxManager.createFinalWall(isDoor: false)
        ...
        let bottomWall = boxManager.createFinalWall(isDoor: false)
        ...
        let backWall = boxManager.createFinalWall(isDoor: false)
        ...
        let leftDoorWall = boxManager.createFinalWall(isDoor: true)
        ...
        let rightDoorWall = boxManager.createFinalWall(isDoor: true)
...
extension FinalPortalViewController: ARSCNViewDelegate {
